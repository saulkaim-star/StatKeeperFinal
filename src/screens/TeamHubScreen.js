...
import { ScrollView, View, Text, StyleSheet, TouchableOpacity, SafeAreaView, ActivityIndicator } from 'react-native';
...
const RecentAnnouncements = ({ announcements, navigation, teamId }) => {
    return (
        <View style={styles.card}>
            ...
            {/* ¡CORRECCIÓN! El Mánager debe pasar 'isPlayerView: false' */}
...
const TeamHubScreen = ({ route, navigation }) => {
  ...
  // --- LÍNEA CORREGIDA ---
  // Ahora "teamName" siempre será 'Team Hub' y no leerá los parámetros.
  ...
  useLayoutEffect(() => {
    navigation.setOptions({
      title: teamName || 'Team Hub', // Esto ahora siempre recibirá 'Team Hub'
    });
  }, [navigation, teamName]);
